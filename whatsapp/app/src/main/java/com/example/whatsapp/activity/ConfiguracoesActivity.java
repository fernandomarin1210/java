...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Recupera id do usuário no Firebase
    ...
    public void atualizaFotoUsuario( Uri url){
        ...
        if (UsuarioFirebase.atualizarFotoUsuario( url )){
            ...
            usuarioLogado.atualizar();
            Toast.makeText(ConfiguracoesActivity.this, "Imagem atualizada com sucesso", Toast.LENGTH_LONG).show();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        //if ( requestCode == 1){ // requestCode identifica de onde foi chamada a função, podendo ter tratamentos diferentes dependendo da chamada
